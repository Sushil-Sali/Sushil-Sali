...
Developed a live ERP/CRM platform for affiliate-based lead and commission management. Built secure REST APIs, authentication, lead management, project allocation, payout workflows, KYC document uploads, and role-based access control.

**Tech:** Node.js, Express.js, MongoDB, JWT, Cloudinary, Nodemailer, Joi Validation

---

#### 📚 Book Store

Built a full-stack Book Store application with authentication, role-based access, and separate access for free and premium books.

**Tech:** Node.js, Express.js, MongoDB, React.js

🔗 **GitHub Repo:** https://github.com/Sushil-Sali/Book-Store
...
Responsive React application that fetches real-time weather data using a weather API.
